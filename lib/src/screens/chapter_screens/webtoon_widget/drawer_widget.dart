...
class DrawerHorizontalWidget extends StatefulWidget {
  ...
  @override
  _DrawerHorizontalWidgetState createState() => _DrawerHorizontalWidgetState();
}

class _DrawerHorizontalWidgetState extends State<DrawerHorizontalWidget> {
  ...
  Widget _buildBottomDrawerBody(BuildContext context) {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      _scrollListController.jumpTo(index: _getIndexChapter, alignment: 0.5);
    });
    return Container(
